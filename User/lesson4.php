...
font-weight:bold;color:#fa3333;">โอ้ยเจ็บ!</strong> กดแรงไปแล้ว</p>';
        ...
        <footer>
            <a href="?module=back_end_time_lesson4&LessonID=<?php echo $LessonID; ?>&Name_lesson=<?php echo $Name_lesson; ?>&LessonDID=<?php echo $row['LessonDID']; ?>">
                <img src="./assets_img/icon/back.svg" alt="back" width="50">
            </a>

            <a href="?module=end_time_lesson4&LessonID=<?php echo $LessonID; ?>&Name_lesson=<?php echo $Name_lesson; ?>&LessonDID=<?php echo $row['LessonDID']; ?>">
