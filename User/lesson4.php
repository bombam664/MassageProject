...
if (!$LessonID) {
    ...
    echo "<META HTTP-EQUIV='Refresh' CONTENT='2;URL=?module=lesson4&LessonID=$LessonID&Name_lesson=$Name_lesson'>";
?>
    ...
    ?>
        ...
        <header>
            <a href="?module=back_end_time_lesson4&LessonID=<?php echo $LessonID; ?>&Name_lesson=<?php echo $Name_lesson; ?>&LessonDID=<?php echo $row['LessonDID']; ?>"><img src="./assets_img/icon/back.svg" alt="back" width="50"></a>
        ...
        " onClick="location.href='?module=start_time_lesson5&LessonID=<?php echo $LessonID; ?>&Name_lesson=<?php echo $Name_lesson; ?>'">
            ...
            <a href="?module=end_time_lesson4&LessonID=<?php echo $LessonID; ?>&Name_lesson=<?php echo $Name_lesson; ?>&LessonDID=<?php echo $row['LessonDID']; ?>"><img src="./assets_img/icon/nextpage.svg" alt="next" width="50"></a>
        </header>
