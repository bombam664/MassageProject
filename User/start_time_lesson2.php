...
$sql="SELECT * FROM lesson_details WHERE LessonID=$LessonID AND Question=2";
...
while($row=$query->fetch_assoc()){
    ...
    if($Question==2){
        ...
        if($querya){
            echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=?module=lesson2&LessonID=$LessonID&Name_lesson=$Name_lesson'>";
        }else{
            echo 'NO OK'.$sqla;
        }
     }else{
