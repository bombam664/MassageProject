...
$sql="SELECT * FROM lesson_details WHERE LessonID=$LessonID AND Question=5";
...
while($row=$query->fetch_assoc()){
    ...
    if($Question==5){
        ...
        if($querya){
            echo "<META HTTP-EQUIV='Refresh' CONTENT='0;URL=?module=lesson5&LessonID=$LessonID&Name_lesson=$Name_lesson'>";
        }else{
            echo 'NO OK'.$sqla;
        }
     }else{
